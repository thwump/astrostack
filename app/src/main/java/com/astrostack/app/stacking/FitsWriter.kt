...
object FitsWriter {
    ...
    /**
     * Writes 32-bit floating point linear RGB pixel values [floatPixels] directly into a FITS file
     * with BITPIX = -32 (IEEE single-precision float).
     */
    fun writeRgbFits(os: OutputStream, width: Int, height: Int, floatPixels: FloatArray) {
        val headerLines = mutableListOf<String>()
        headerLines.add("SIMPLE  =                    T / file does conform to FITS standard")
        headerLines.add("BITPIX  =                  -32 / number of bits per data pixel (float)")
        headerLines.add("NAXIS   =                    3 / number of data axes")
