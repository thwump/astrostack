...
#ifndef ASTROSTACKAPP_SWIFT_H
#define ASTROSTACKAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AstroStackApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13AstroStackApp15AVCameraManager")
...
@interface AVCameraManager (SWIFT_EXTENSION(AstroStackApp)) <AVCapturePhotoCaptureDelegate>
